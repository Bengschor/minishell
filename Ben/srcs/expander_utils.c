...
/*   Updated: 2024/04/26 19:12:51 by bschor           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * Concatenate the part of the original string that comes after the replaced substring.
...
/**
 * @brief Finds the index of the next non-alphanumeric character or underscore in the string.
 ...
 * 3-5: Iterate through the string until a non-alphanumeric character or underscore is encountered.
 * 6: Return the index i when the first non-alphanumeric character or underscore is found.
*/
 ...
 * @line by line:
 * 4: Check if the length of the string matches the length of the current environment variable minus the length of the key (characters before the equal sign).
 * 5: Compare the string with the current environment variable using `ft_strncmp`.
